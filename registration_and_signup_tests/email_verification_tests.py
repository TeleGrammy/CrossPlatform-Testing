...
class EmailVerificationTests(unittest.TestCase):
    ...
    def test_resend_verification_email(self):
        ...
        self.driver.find_element_by_xpath(XPaths.SIGNUP_VERIFICATION_CODE_SEND_AGAIN.value).click()
    ...
    def test_multiple_clicks_on_verification_button(self):
        ...
        err_msg = self.driver.find_element_by_xpath(XPaths.EXCEPTION_WHEN_SUBMIT_VERIFY_CODE.value)
    ...
    def test_verification_with_wrong_code(self):
        ...
        self.register_and_trigger_email()
        time.sleep(3)
        self.driver.find_element_by_xpath(XPaths.SIGNUP_VERIFICATION_CODE_FIELD.value).send_keys("123456")
        self.driver.find_element_by_xpath(XPaths.SIGNUP_VERIFY_CONFIRMATION_CODE_BUTTON.value).click()
        err_msg = self.driver.find_element_by_xpath(XPaths.EXCEPTION_WHEN_SUBMIT_VERIFY_CODE.value)
